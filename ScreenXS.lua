...
--fonts--
font_big = loadFont('Oxanium-Bold',44)
font_small = loadFont('Oxanium',29)
font_tiny = loadFont('Oxanium-Light',18)
----------------------------------------------------------
------------------ FUNCTIONS -----------------------------
----------------------------------------------------------
--Cursor setup--
...
addText(frontlayer,font_small,"Target:",50,ry/2-240)
addText(frontlayer,font_small,"Gravity Well:",50,ry/2-200)
addText(frontlayer,font_small,"Current: ",50,ry/2-160)
addText(frontlayer,font_small,"Time:",50,ry/2-120)
